...
naver_textrecog_test = dict(
    ann_file='/home/vht/hahoang/HackthonOCR/DATA/team/data_partition/val2.json',
    data_root=naver_textrecog_data_root,
    pipeline=None,
    test_mode=True,
    type='OCRDataset')
naver_textrecog_train = dict(
    ann_file='/home/vht/hahoang/HackthonOCR/DATA/team/data_partition/train2.json',
    data_root=naver_textrecog_data_root,
    pipeline=None,
    test_mode=False,
    type='OCRDataset')
...
launcher = 'slurm'
work_dir = './work_dirs/abinet_case_unchanged_fold2'